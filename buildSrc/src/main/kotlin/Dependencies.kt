...
object Libs {
    ...
    const val LIVEDATA_LIFECYCLE="androidx.lifecycle:lifecycle-livedata-ktx:${Versions.LIFECYCLE_VIEW_MODEL_KTX}"
...
//    const val LIFECYCLE_EXT="androidx.lifecycle:lifecycle-extensions:${Versions.LIFECYCLE_VIEW_MODEL_KTX}"
    ...
    const val RXPAGING = "androidx.paging:paging-rxjava3:${Versions.PAGING}"
